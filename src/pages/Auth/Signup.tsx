  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { success, error } = await signup({
        ...
        // We might want to pass role if the backend allows it, but often it's restricted
      });
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className={`flex-1 py-3 px-4 rounded-lg border-2 font-medium transition-all duration-200 ${formData.role === 'employee'
                ...
                <button
                  ...
                  className={`flex-1 py-3 px-4 rounded-lg border-2 font-medium transition-all duration-200 ${formData.role === 'hr'
                    ? 'border-primary bg-primary/10 text-primary'
                    : 'border-border bg-background text-muted-foreground hover:border-primary/50'
                    }`}
                >
